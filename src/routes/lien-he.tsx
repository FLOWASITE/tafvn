        ...
        <div className="grid lg:grid-cols-12 gap-12">
          <header className="lg:col-span-5">
            ...
            <p className="mt-5 text-lg text-muted-foreground font-serif leading-relaxed">
              Mô tả ngắn về doanh nghiệp, loại hình, thời điểm cần báo cáo — KTV phụ trách sẽ
              liên hệ lại trong vòng 1 ngày làm việc với khảo sát sơ bộ và đề xuất phí cụ thể
              trong 3 ngày.
            </p>
            <div className="mt-8 space-y-2 font-serif text-sm text-foreground/80">
              <p>
                <strong className="font-display text-foreground">Khảo sát miễn phí.</strong> Không
                ràng buộc cho đến khi ký hợp đồng dịch vụ.
              </p>
              <p>
                <strong className="font-display text-foreground">Bảo mật thông tin.</strong> TAF
                không chia sẻ dữ liệu của bạn với bên thứ ba.
              </p>
            </div>
          </header>
