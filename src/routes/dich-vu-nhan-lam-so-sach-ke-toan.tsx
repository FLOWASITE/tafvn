...
export const Route = createFileRoute("/dich-vu-nhan-lam-so-sach-ke-toan")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: `${SITE_ORIGIN}/toi-uu-hoa-tai-chinh-voi-dich-vu-ke-toan-thue-chuyen-nghiep.jpg` },
      { property: "og:image:alt", content: "Dịch vụ làm sổ sách kế toán A–Z — TAF" },
      { property: "og:site_name", content: "TAF" },
      { property: "og:locale", content: "vi_VN" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: TITLE },
      { name: "twitter:description", content: DESCRIPTION },
      { name: "twitter:image", content: `${SITE_ORIGIN}/toi-uu-hoa-tai-chinh-voi-dich-vu-ke-toan-thue-chuyen-nghiep.jpg` },
    ],
