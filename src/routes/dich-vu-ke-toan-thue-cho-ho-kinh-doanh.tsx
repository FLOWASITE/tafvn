...
export const Route = createFileRoute("/dich-vu-ke-toan-thue-cho-ho-kinh-doanh")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: `${SITE_ORIGIN}/ho-kinh-doanh-ke-khai-thue-quy-i-2026-taf.jpg` },
      { property: "og:image:alt", content: "Dịch vụ kế toán thuế cho hộ kinh doanh — TAF" },
      { property: "og:site_name", content: "TAF" },
      { property: "og:locale", content: "vi_VN" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: TITLE },
      { name: "twitter:description", content: DESCRIPTION },
      { name: "twitter:image", content: `${SITE_ORIGIN}/ho-kinh-doanh-ke-khai-thue-quy-i-2026-taf.jpg` },
    ],
