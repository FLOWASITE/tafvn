      ...
      <div className="mx-auto max-w-6xl px-5 md:px-8 py-16 grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
        ...
        <div className="md:col-span-4 space-y-6">
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            ...
            <a href="https://www.youtube.com/channel/UC6SN58so0Iy1nnf46LYJw1A" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-primary-foreground/60 hover:text-accent transition-colors">
            ...
            <a href="https://x.com/dichvuketoantaf" target="_blank" rel="noopener noreferrer" aria-label="X" className="text-primary-foreground/60 hover:text-accent transition-colors">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="https://www.instagram.com/tax_audit_finance/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-primary-foreground/60 hover:text-accent transition-colors">
            ...
            <a href="https://www.linkedin.com/in/dichvuketoantaf1/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-primary-foreground/60 hover:text-accent transition-colors">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </a>
            <a href="https://www.pinterest.com/dichvukiemtoantaf" target="_blank" rel="noopener noreferrer" aria-label="Pinterest" className="text-primary-foreground/60 hover:text-accent transition-colors">
            ...
            <a href="https://www.tiktok.com/@ketoan.taf" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-primary-foreground/60 hover:text-accent transition-colors">
            ...
            <a href="https://www.threads.com/@tax_audit_finance" target="_blank" rel="noopener noreferrer" aria-label="Threads" className="text-primary-foreground/60 hover:text-accent transition-colors">
          ...
          {primary ? (
            <address className="not-italic space-y-4 text-sm">
              <div className="space-y-1">
                <p className="font-semibold text-primary-foreground tracking-tight">{primary.name}</p>
                <p className="text-primary-foreground/60 font-serif leading-relaxed">
